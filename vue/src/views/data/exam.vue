<template>
  <el-card class="page-container">
      ...
      <div class="header">
        ...
        <div class="extra">
          <el-button type="primary"
                     @click="drawVisible = true;title='添加考试'; courseModel.courseCode=null;courseModel.courseName=null;courseModel.courseDesc=null;">
            添加考试
          </el-button>
        </div>
      </div>
    ...
    <el-table :data="courseList" style="width: 100%">
      <el-table-column label="考试编号" prop="courseCode" width="150"></el-table-column>
      <el-table-column label="考试名称" prop="courseName"></el-table-column>
      <el-table-column label="考试简介" prop="courseDesc"></el-table-column>
  ...
  >
    <el-form :model="courseModel" :rules="rules" label-width="100px" style="padding-right: 30px">
      <el-form-item label="考试编号" prop="courseCode">
      ...
      <el-form-item label="考试简介" prop="courseDesc">
        <el-input 
          v-model="courseModel.courseDesc" 
          type="textarea"
          :rows="4"
          maxlength="100"
          placeholder="请输入考试简介（最多100字）"
        ></el-input>
      </el-form-item>
    </el-form>
    ...
    <span class="draw-footer">
      <el-button type="primary"
                 @click="title==='添加考试'? addCourse():updateCourse()">
        {{ title.slice(0, 2) }}
      </el-button>
