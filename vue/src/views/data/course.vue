<template>
  <el-card class="page-container">
      ...
      <div class="header">
        ...
        <div class="extra">
          <el-button type="primary"
                     @click="drawVisible = true;title='添加课程'; courseModel.courseCode=null;courseModel.courseName=null;courseModel.courseDesc=null;">
            添加课程
          </el-button>
        </div>
      </div>
    ...
    <el-table :data="courseList" style="width: 100%">
      <el-table-column label="课程编号" prop="courseCode" width="150"></el-table-column>
      <el-table-column label="课程名称" prop="courseName"></el-table-column>
      <el-table-column label="课程简介" prop="courseDesc"></el-table-column>
  ...
  >
    ...
    <span class="draw-footer">
      <el-button type="primary"
                 @click="title==='添加课程'? addCourse():updateCourse()">
        {{ title.slice(0, 2) }}
      </el-button>
